...
class MyHistoListMatch extends StatefulWidget {
  const MyHistoListMatch({Key? key}) : super(key: key);

  @override
  State<MyHistoListMatch> createState() => _MyListMatchState();
}

class _MyListMatchState extends State<MyHistoListMatch> {
    ...
    return Padding(
      ...
      child: Card(
        ...
        shape: RoundedRectangleBorder(
          side: BorderSide(
            color: Colors.grey, // Remplacez Colors.red par la couleur de votre choix
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text("${matchPari.pari_a!.resultStatus!}",style: TextStyle(color:matchPari.pari_a!.resultStatus==PariResultStatus.GAGNER.name?Colors.green : Colors.red,fontWeight: FontWeight.w600,fontSize: 12),),
                  ...
                  Column(
                    children: [
                      ...
                      Text("${matchPari.pari_b!.resultStatus!}",style: TextStyle(color:matchPari.pari_b!.resultStatus==PariResultStatus.GAGNER.name?Colors.green : Colors.red,fontWeight: FontWeight.w600,fontSize: 12),),
                  ...
                  builder: (BuildContext context, StateSetter setStateb) {
                    ...
                    Container(
                        ...
                        child: onTap? Container(
                            ...
                            child: CircularProgressIndicator()):Text("Voir",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w900,fontSize: 15),)));
                  }
              ),
              SizedBox(width: width*0.3,),
              Card(child: Padding(
                ...
                child: ListView(
                  children: [
                    ...
                    StreamBuilder<List<MatchPari>>(
                        stream: equipeProvider.getHistoListMatch(serviceProvider.loginUser.id_db!),
