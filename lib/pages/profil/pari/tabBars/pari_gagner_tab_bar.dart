...
class PariGagner extends StatefulWidget {
  const PariGagner({super.key});

  @override
  State<PariGagner> createState() => _AllPariState();
}

class _AllPariState extends State<PariGagner> {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: StreamBuilder<List<Pari>>(
          stream: equipeProvider.getUserPariResultStatus(serviceProvider.loginUser.id_db!,PariResultStatus.GAGNER.name),
