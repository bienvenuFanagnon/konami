...
class HistoPari extends StatefulWidget {
  const HistoPari({super.key});

  @override
  State<HistoPari> createState() => _AllPariState();
}

class _AllPariState extends State<HistoPari> {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: StreamBuilder<List<Pari>>(
          stream: equipeProvider.getUserHistoListPari(serviceProvider.loginUser.id_db!),
