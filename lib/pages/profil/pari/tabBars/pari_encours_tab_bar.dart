...
class UserPariEnCours extends StatefulWidget {
  const UserPariEnCours({super.key});

  @override
  State<UserPariEnCours> createState() => _AllPariState();
}

class _AllPariState extends State<UserPariEnCours> {
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: StreamBuilder<List<Pari>>(
          stream: equipeProvider.getUserPariResultStatus(serviceProvider.loginUser.id_db!,PariResultStatus.NAN.name),
