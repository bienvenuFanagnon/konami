...
import 'package:konami_bet/pages/profil/pari/tabBars/all_pari_tab_bar.dart';
import 'package:konami_bet/pages/profil/pari/tabBars/histo_pari_tab_bar.dart';
import 'package:konami_bet/pages/profil/pari/tabBars/pari_encours_tab_bar.dart';
import 'package:konami_bet/pages/profil/pari/tabBars/pari_gagner_tab_bar.dart';
import 'package:konami_bet/pages/profil/pari/tabBars/pari_perdu_tab_bar.dart';
...
class UserHistoriquePari extends StatefulWidget {
  const UserHistoriquePari({Key? key}) : super(key: key);

  @override
  State<UserHistoriquePari> createState() => _PariEnCoursState();
}

class _PariEnCoursState extends State<UserHistoriquePari> {
